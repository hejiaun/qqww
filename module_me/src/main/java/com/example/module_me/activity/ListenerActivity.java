 ...
 * @Author: HeJiaJun
 * @Description: 收听列表Activity
 */
@RequiresApi(api = Build.VERSION_CODES.O)
public class ListenerActivity extends BaseActivity<PopularityActivityPresenter> implements IPopularityActivityView {
    ...
    public void initConfig() {
        ...
        adapter = new ListenAdapter(R.layout.item_person_play, new ArrayList<UserEntity>());
