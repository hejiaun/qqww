 ...
 * @Description:
 */
public class BindEmailActivityPresenter extends BasePresenter<IBindEmailActivityView> {

    /**
     * 构造方法，初始化View层
     *
     * @param iBindEmailActivityView View层接口
     */
    public BindEmailActivityPresenter(IBindEmailActivityView iBindEmailActivityView) {
        super(iBindEmailActivityView);
    }
