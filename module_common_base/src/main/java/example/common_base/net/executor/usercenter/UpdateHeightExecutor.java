 ...
 * Author: HeJiaJun
 * Description:更新用户身高资料的执行器
 */
public class UpdateHeightExecutor
        extends AuthJsonServiceClientExecutor<VFighterRequest<UpdateUserInfoParam>, ResponseSingle<Boolean>> {

    private static final String endpoint = RestInterfaceUrl.usercenter_updateHeight;
     ...
     * 创建客户端执行器
     */
    public UpdateHeightExecutor(UpdateUserInfoParam param) {
