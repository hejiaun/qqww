 ...
 * Author: HeJiaJun
 * Description:更新用户性格描述资料的执行器
 */
public class UpdateNatureExecutor
        extends AuthJsonServiceClientExecutor<VFighterRequest<UpdateUserInfoParam>, ResponseSingle<Boolean>> {
    private static final String endpoint = RestInterfaceUrl.usercenter_updateNature;
     ...
     * @param param 参数
     */
    public UpdateNatureExecutor(UpdateUserInfoParam param) {
