 ...
 * Author: HeJiaJun
 * Description:更新用户自我描述的执行器
 */
public class UpdateDescExecutor
        extends AuthJsonServiceClientExecutor<VFighterRequest<UpdateUserInfoParam>, ResponseSingle<Boolean>> {
    private static final String endpoint = RestInterfaceUrl.usercenter_updateDesc;
     ...
     * @param param 参数
     */
    public UpdateDescExecutor(UpdateUserInfoParam param) {
