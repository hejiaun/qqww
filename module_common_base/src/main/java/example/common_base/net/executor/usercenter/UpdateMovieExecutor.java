 ...
 * Author: HeJiaJun
 * Description:更新用户喜欢的电影资料的执行器
 */
public class UpdateMovieExecutor
        extends AuthJsonServiceClientExecutor<VFighterRequest<UpdateUserInfoParam>, ResponseSingle<Boolean>> {
    private static final String endpoint = RestInterfaceUrl.usercenter_updateMovie;
     ...
     * @param param 参数
     */
    public UpdateMovieExecutor(UpdateUserInfoParam param) {
