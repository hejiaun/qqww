 ...
 * 删除音乐圈评论的执行器
 */
public class DeleteMusicCircleCommentExecutor
        extends AuthJsonServiceClientExecutor<VFighterRequest<Long>, ResponseSingle<Boolean>> {
    private static final String endpoint = RestInterfaceUrl.comment_deleteMusicCircleComment;
    private static final TypeToken<ResponseSingle<Boolean>> token = new TypeToken<ResponseSingle<Boolean>>() {
    };


    public DeleteMusicCircleCommentExecutor(Long param) {
