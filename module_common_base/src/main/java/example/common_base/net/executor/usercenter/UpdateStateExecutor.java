 ...
 * Author: HeJiaJun
 * Description:更新用户状态资料的执行器
 */
public class UpdateStateExecutor
        extends AuthJsonServiceClientExecutor<VFighterRequest<UpdateUserInfoParam>, ResponseSingle<Boolean>> {

    private static final String endpoint = RestInterfaceUrl.usercenter_updateState;
     ...
     * @param param 参数
     */
    public UpdateStateExecutor(UpdateUserInfoParam param) {
