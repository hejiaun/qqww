 ...
 * 根据歌手名关键字获取公开伴奏 执行器
 */
public class SearchPubKeyWordAccompanimentByOriginalExecutor extends
        AuthJsonServiceClientExecutor<VFighterRequest<SearchByKeyWordParam>, ResponseCollection<Accompaniment>> {
    private static final String endpoint = RestInterfaceUrl.songlib_searchPubKeyWordAccompanimentByOriginal;
     ...
     * @return
     */
    public SearchPubKeyWordAccompanimentByOriginalExecutor(SearchByKeyWordParam param) {
