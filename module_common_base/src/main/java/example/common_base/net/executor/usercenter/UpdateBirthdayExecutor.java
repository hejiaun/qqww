 ...
 * Author: HeJiaJun
 * Description:更新用户生日资料的执行器
 */
public class UpdateBirthdayExecutor
        extends AuthJsonServiceClientExecutor<VFighterRequest<UpdateUserInfoParam>, ResponseSingle<Boolean>> {
    private static final String endpoint = RestInterfaceUrl.usercenter_updateBirthday;
     ...
     * @param param 参数
     */
    public UpdateBirthdayExecutor(UpdateUserInfoParam param) {
