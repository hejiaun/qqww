 ...
 * Author: HeJiaJun
 * Description:更新用户性别资料的执行器
 */
public class UpdateSexExecutor
        extends AuthJsonServiceClientExecutor<VFighterRequest<UpdateUserInfoParam>, ResponseSingle<Boolean>> {

    private static final String endpoint = RestInterfaceUrl.usercenter_updateSex;
     ...
     * @param param 参数
     */
    public UpdateSexExecutor(UpdateUserInfoParam param) {
