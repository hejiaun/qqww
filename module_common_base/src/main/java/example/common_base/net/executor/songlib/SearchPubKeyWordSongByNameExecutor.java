 ...
 * 根据歌名关键字获取公开歌曲 执行器
 */
public class SearchPubKeyWordSongByNameExecutor
        extends AuthJsonServiceClientExecutor<VFighterRequest<SearchByKeyWordParam>, ResponseCollection<Song>> {
    private static final String endpoint = RestInterfaceUrl.songlib_searchPubKeyWordSongByName;
     ...
     * @return
     */
    public SearchPubKeyWordSongByNameExecutor(SearchByKeyWordParam param) {
