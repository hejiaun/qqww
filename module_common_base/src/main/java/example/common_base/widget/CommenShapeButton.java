...
public class CommenShapeButton extends AppCompatButton {
    ...
    public CommenShapeButton(Context context) {
        super(context);
    }

    public CommenShapeButton(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        init(context, attrs);
    }

    public CommenShapeButton(Context context, AttributeSet attrs, int defStyleAttr) {
