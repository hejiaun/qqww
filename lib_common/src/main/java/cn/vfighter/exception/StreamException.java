...
public class StreamException extends IOException {
    ...
    public StreamException(String message) {
        super(ERROR_OS_IO_STREAM, message);
    }
     ...
     * @param message 异常消息
     */
    public StreamException(short code, String message) {
        super(code, message);
    }
    ...
    public StreamException(String message, Throwable cause) {
        super(ERROR_OS_IO_STREAM, message, cause);
    }
     ...
     * @param cause 产生异常的原因（源异常）
     */
    public StreamException(short code, String message, Throwable cause) {
