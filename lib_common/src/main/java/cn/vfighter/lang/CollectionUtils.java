...
public class CollectionUtils {
    ...
    /**
     * 将数组的内容转换为集合对象，注意该集合对象的可以修改的， 注意区别JDK
     * API{@linkplain Arrays#asList(Object[])}不同。
     ...
     * </p>
     * 该方法在Web应用程序下比较适合使用，如果两个分割后的长度不一致，则取较短的部分。 以下是示例说明：
     * 
     * <pre>
     *   keys =    a,b,c
     *   values = 1,2,3,4
     ...
     * 
     * <pre class="code">
     * CollectionUtils.toStringArray(Arrays.asList("hello", "boy", "amazing")); // ---
     *                                                                          // [boy,hello,amazing]
     * </pre>
     *
    ...
    public static String toString(final Collection<String> src, String delimiter,
        ...
        if (delimiter == null)
            delimiter = StringUtils.EMPTY_STRING;
     ...
     * @return 返回字符串
     */
    public static String toString(final Map<String, String> data, String keyDelimiter,
     ...
     * @return 返回字符串
     */
    private static String toString(final Map<String, String> data, String keyDelimiter,
            String entryDelimiter, boolean keySortable, boolean ignoreEmpty) {
        if (isEmpty(data))
            return StringUtils.EMPTY_STRING;
        if (keyDelimiter == null)
            keyDelimiter = StringUtils.EMPTY_STRING;
        if (entryDelimiter == null)
            entryDelimiter = StringUtils.EMPTY_STRING;
