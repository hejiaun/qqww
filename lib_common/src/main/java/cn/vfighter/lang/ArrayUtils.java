...
public class ArrayUtils {
     ...
     * 
     * <pre class="code">
     * ObjectUtils.containsElement(new String[] { "aaaa", "bbb", "cc", null }, null); // ---
     *                                                                                // true
     * ObjectUtils.containsElement(new String[] { "aaaa", "bbb", "cc" }, "cc"); // ---
     *                                                                          // true
     * ObjectUtils.containsElement(new String[] { "aaaa", "bbb", "cc", null }, "xx"); // ---
     *                                                                                // false
     * </pre>
     *
     * @param array 数组
     ...
     * 
     * <pre class="code">
     * StringUtils.addStringToArray(new String[] { "hello" }, "world"); // ---
     *                                                                  // [hello,world]
     ...
     * 
     * <pre class="code">
     * StringUtils.concatStringArrays(new String[] { "girl", "women" },
     *         new String[] { "boy", "girl" }); // --- [girl,women,boy,girl]
     * </pre>
     *
     * @param arr1 数组
     * @param arr2 数组
     ...
     * 
     * <pre class="code">
     * StringUtils.mergeStringArrays(new String[] { "girl", "women" },
     *         new String[] { "boy", "girl" }); // --- [girl,women,boy]
     * </pre>
     *
     * @param array1 数组
     * @param array2 数组
     ...
     * 
     * <pre class="code">
     * StringUtils.sortStringArray(new String[] { "hello", "boy", "amazing" }); // ---
     *                                                                          // [amazing,boy,hello]
     * </pre>
     *
     * @param array 数组
