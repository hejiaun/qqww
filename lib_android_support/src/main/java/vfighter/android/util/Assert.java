...
public abstract class Assert {
     ...
     *            context. It should normally end in ":" or "." so that the
     *            generated message looks OK when appended to it.
     * @throws IllegalArgumentException if the object is not an instance of
     *             clazz
     * @see Class#isInstance
     */
    public static void isInstanceOf(Class<?> type, Object obj, String message) {
        ...
        if (!type.isInstance(obj)) {
            throw new IllegalArgumentException((!StringUtils.isEmpty(message) ? message + " " : "")
