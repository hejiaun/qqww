...
import vfighter.android.util.SparseArray;
import vfighter.android.util.SparseBooleanArray;
...
public final class Parcel {
     ...
     *
     * @param size The new capacity of the parcel, in bytes. Can not be less than
