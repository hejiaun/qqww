...
/**
 * JSON service client executor 以表单POST的方式请求服务,本类默认采用
...
public abstract class FormServiceClientExecutor<P, T> implements IExecutor<T> {
    private static final RequestParamsUtils requestParamsUtils = new RequestParamsUtils() {
    ...
    public FormServiceClientExecutor(String endpoint, P param) {
    ...
    private HttpEntity post() throws ClientProtocolException, IOException, HttpResponseException,
        ...
        HttpEntity rp = requestParamsUtils.convert(param);
