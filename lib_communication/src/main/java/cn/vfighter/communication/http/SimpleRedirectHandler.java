...
/**
 * 重定向句柄的简易实现 来自StackOverflow
 * 
 * @author Aymon Fournier, aymon.fournier@gmail.com
 * @see <a href=
 *      "https://stackoverflow.com/questions/3420767/httpclient-redirecting-to-url-with-spaces-throwing-exception">https://stackoverflow.com/questions/3420767/httpclient-redirecting-to-url-with-spaces-throwing-exception</a>
 */
@SuppressWarnings({ "deprecation" })
class SimpleRedirectHandler extends DefaultRedirectHandler {

    private static final String REDIRECT_LOCATIONS = "http.protocol.redirect-locations";
    private final boolean enableRedirects;

    public SimpleRedirectHandler(final boolean allowRedirects) {
        super();
