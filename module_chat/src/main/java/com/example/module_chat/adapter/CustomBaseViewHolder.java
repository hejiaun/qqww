...
public class CustomBaseViewHolder extends BaseViewHolder {
    ...
    private LQRNineGridImageViewAdapter lqrNineGridImageViewAdapter;
...
//                        .load(res)
//                        .into(imageView);
        if (lqrNineGridImageViewAdapter == null) {
            lqrNineGridImageViewAdapter = new LQRNineGridImageViewAdapter<String>() {
                @Override
