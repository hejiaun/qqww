...
import com.example.module_task.presenter.DailyTaskFragmentPresenter;
 ...
 * Author: HeJiaJun
 * Description:日常任务fragment
 */
public class DailyTaskFragment extends BaseListFragment<DailyTaskFragmentPresenter> implements IDailyTaskFragmentView {
     ...
     */
    @Override
    public DailyTaskFragmentPresenter createPresenter() {
        return new DailyTaskFragmentPresenter(this);
    }
